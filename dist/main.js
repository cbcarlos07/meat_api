...
server.bootstrap([users_router_1.usersRouter, restaurants_router_1.restaurantsRouter, reviews_router_1.reviewRouter, main_router_1.mainRouter]).then(function (server) {
